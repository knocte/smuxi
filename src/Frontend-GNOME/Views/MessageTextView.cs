...
namespace Smuxi.Frontend.Gnome
{
    public class MessageTextView : Gtk.TextView
    {
        ...
        public void AddMessage(MessageModel msg, bool addLinebreak, bool showTimestamps)
        {
            ...
            foreach (MessagePartModel msgPart in msg.MessageParts) {
                ...
                if (msgPart is UrlMessagePartModel) {
                    InsertToBuffer(buffer, iter, (UrlMessagePartModel) msgPart);
                } else if (msgPart is TextMessagePartModel) {
                    InsertToBuffer(buffer, iter, (TextMessagePartModel) msgPart);
                } else if (msgPart is ImageMessagePartModel) {
                    InsertToBuffer(buffer, iter, (ImageMessagePartModel) msgPart);
                }
            }
        ...
        private void InsertToBuffer(Gtk.TextBuffer buffer, Gtk.TextIter iter, UrlMessagePartModel urlPart)
        {
        ...
        private void InsertToBuffer(Gtk.TextBuffer buffer, Gtk.TextIter iter, TextMessagePartModel fmsgti)
        {
            if (fmsgti.Text == null) {
        ...
        private void InsertToBuffer(Gtk.TextBuffer buffer, Gtk.TextIter iter, ImageMessagePartModel imgpart)
        {
            Uri uri = null;
            string scheme = null;
            try {
